        ...
        content: () => (
            <>
                ...
                <n-p>
                    ...
                    和 Bilibili 收藏集的表情包直接保存为 PNG/GIF
                    文件（可以长按保存），或将整个表情包保存为 ZIP
                    文件，方便在其他地方使用。
                </n-p>
                <n-p>
                    本站只提供表情包存档和下载，与相关企划、作者和企业没有关联，在下载和使用表情包前请自行确认使用授权。
                </n-p>
                <n-p>
                ...
                <n-p>
                    由于获取 QQ 表情包的原作者信息需要使用 QQ
                    登录，因此无法获取和展示这部分内容，请使用 QQ
                    打开对应的表情商城页面查看。
                </n-p>
                <n-p>
                    如果需要获取表情包以外的 Bilibili 收藏集素材，可以前往
                    <n-a
                        href="https://laplace.live/collections"
                        target="_blank"
                    >
                        哔哩哔哩收藏集全图鉴 ✽ LAPLACE
                    </n-a>
        ...
        window.chiya.dialog.alert({
            ...
            content: () => (
                <>
                    ...
                    <n-p>
                        如果需要打包下载表情包，请在浏览器中打开本站（可以点击右上角复制当前页面链接），或直接从
                        QQ 的
                        <n-a
                            href="https://zb.vip.qq.com/hybrid/emoticonmall/home"
                            target="_blank"
